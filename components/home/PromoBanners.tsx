...
export function PromoBanners() {
  return (
    <div className="mx-auto grid w-full max-w-[960px] grid-cols-1 gap-3 md:grid-cols-[1fr_1fr] lg:grid-cols-[0.96fr_1.18fr_0.96fr]">
        <article className="relative h-[176px] overflow-hidden rounded-lg bg-[#18181b] p-5 text-white shadow-[0_10px_22px_rgba(0,0,0,0.14)]">
          <div className="relative z-10 flex h-full flex-col items-start justify-between">
            ...
            <a href="#" className="inline-flex h-7 items-center border border-white/35 px-3 text-[9px] font-bold uppercase text-white transition-colors hover:border-white hover:bg-white hover:text-zinc-950">
              Mua ngay
            </a>
          </div>
        ...
        <article className="relative h-[176px] overflow-hidden rounded-lg bg-[#bb0009] p-5 text-white shadow-[0_10px_22px_rgba(0,0,0,0.14)] md:col-span-2 lg:col-span-1">
          <span className="pointer-events-none absolute right-4 top-1 font-heading text-[92px] font-black leading-none text-white/10">
            0%
          </span>
          <div className="relative z-10 flex h-full flex-col items-start justify-between">
            <div>
              ...
              <p className="mt-2 text-[10px] font-semibold uppercase text-white/90">Thủ tục nhanh gọn</p>
            </div>
            <a href="#" className="inline-flex h-7 items-center bg-white px-3 text-[9px] font-bold uppercase text-zinc-950 transition-colors hover:bg-zinc-950 hover:text-white">
              Xem xe ngay
            </a>
          </div>
        ...
        <article className="relative h-[176px] overflow-hidden rounded-lg bg-[#18181b] p-5 text-white shadow-[0_10px_22px_rgba(0,0,0,0.14)]">
          <span className="pointer-events-none absolute right-4 top-1 font-heading text-[92px] font-black leading-none text-white/[0.03]">
            100
          </span>
          <div className="relative z-10 flex h-full flex-col items-start justify-between">
            <div>
